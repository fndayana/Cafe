...
function UpdateData(){
    ...
    if($reserve_date && $reserve_time && $reserve_person){
        $sql = "
                    UPDATE reservation SET reserve_date='$reserve_date', reserve_time = '$reserve_time', reserve_person = '$reserve_person' WHERE reserve_id='$reserve_id';                    
        ";
...
function deleteRecord(){
    $reserve_id = (int)textboxValue("reserve_id");
